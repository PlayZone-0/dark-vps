"""
Pro VPS Panel - Complete & Updated
Owner: dark / dark_devloper
"""
...
if os.environ.get("VERCEL"):
    ...
    FILES_ROOT = Path("/tmp/user_files")
...
app = Flask(__name__, template_folder="../templates" if os.environ.get("VERCEL") else "templates")
...
def extract_imports_from_file(fpath):
    """AST ka use karke python file se import kiye gaye modules nikalta hai"""
    imports = set()
    try:
